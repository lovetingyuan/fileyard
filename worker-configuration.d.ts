/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ac1199f6d8368325523d9085810277f8)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SENDER_EMAIL: "File Share <files-share@tingyuan.in>";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		RESEND_API_KEY: string;
		SHARE_LINK_SECRET: string;
		RATE_LIMITER: DurableObjectNamespace<import("./src/worker/index").RateLimitDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "MAX_UPLOAD_BYTES" | "SENDER_EMAIL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "SHARE_LINK_SECRET">> {}
}
